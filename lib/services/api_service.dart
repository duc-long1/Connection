...
class ApiService {
  ...
  Future<void> uploadAvatarToServer(File imageFile) async {
    ...
    await _dio.post('http://chocaycanh.club/public/api/me/avatar',
  ...
  Future<Response?> dangkyLop() async {
    ...
    String apiUrl = "http://chocaycanh.club/api/lophoc/dangky";
    try {
  ...
  Future<Response?> updateProfile() async {
    ...
    String birthday = "";
    if (profile.user.birthday.isEmpty) {
    ...
    Map<String, dynamic> param = {
      "first_nam": profile.user.first_name ?? "",
      "last_name": '',
    ...
    String apiUrl = "http://chocaycanh.club/api/me/details";
    try {
      final response = await _dio.post(apiUrl,
          options: Options(headers: headers), data: jsonEncode(param));
      if (response.statusCode == 200) {
  ...
  Future<Response?> getUserInfo() async {
    ...
    String apiUrl = "http://chocaycanh.club/api/me";
    try {
      final response =
          await _dio.get(apiUrl, options: Options(headers: headers));
      if (response.statusCode == 200) {
  ...
  Future<Response?> getStudentInfo() async {
    ...
    String apiUrl = "http://chocaycanh.club/api/sinhvien/info";
    try {
      final response =
          await _dio.get(apiUrl, options: Options(headers: headers));
      if (response.statusCode == 200) {
